...
export default function ProjectBuilder() {
  ...
  const send = async () => {
    ...
    try {
      setRunning(true);
      // For now: regenerate plan based on provider/model; we could extend backend to accept prompt updates later.
    ...
    <div className="min-h-screen bg-[hsl(210,20%,98%)]">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-lg font-semibold tracking-tight">{project?.name || "Loading…"}</h1>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-6 grid grid-cols-4 gap-6">
        ...
        <section className="col-span-4 md:col-span-1">
          <Card className="h-[calc(100vh-160px)] sticky top-[88px] flex flex-col">
